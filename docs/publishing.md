...
| **Documentation site** | **Owner:** Settings > Pages > Source: GitHub Actions. The site deploys to https://eddyboutros.github.io/rayfold/ on every push to `main` (`.github/workflows/docs.yml`). With GitHub Pro this works while the repository is private, but the site itself is public. |
