...
export const ERROR_TYPES: ErrorType[] = [
  ...
  },
  {
    ...
    causes: ["A request asked for a position, offset or cursor beyond the available data."],
  ...
  },
  {
    ...
    causes: ["A create command for an id, name or other unique value that is taken."],
    fixes: ["Read the existing item instead, or choose another value."],
    retryable: false,
  ...
  },
  {
    ...
    causes: ["Two changes to the same data raced, and this one lost."],
  ...
  },
  {
    ...
    causes: ["An operation or extension this server does not provide, or a feature its transport does not offer."],
  ...
  },
  {
    ...
    causes: ["Usually a lower layer, such as a library or another service, failed without a usable code."],
  ...
  },
  {
    ...
    causes: ["Storage failed or returned data that does not make sense."],
